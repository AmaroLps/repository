...
//             <div className="bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm">
//               <img
//                 src="/image00001.png"
//                 alt="Logo"
...
export default function DrawerAppBar(props: Props) {
  ...
  // Usar el contexto del layout
  const { drawerOpen, toggleDrawer, drawerWidth, topBarHeight, isMobile } = useLayout();
